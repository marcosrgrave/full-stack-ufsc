...
import org.springframework.data.util._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(CustomCollectionRegistrar.class, () -> _FactoryProvider.customCollectionsVavrCollections());
    factories.add(CustomCollectionRegistrar.class, () -> _FactoryProvider.customCollectionsEclipseCollections());
